...
function lineTo(from, to, val) {
  ...
  let changed = false;
  for (;;) {
    changed = setPixel(x0, y0, val) || changed;
...
function beginStroke(e) {
  ...
  lastCell = cell;
  setPixel(cell.c, cell.r, paintingValue);
...
function moveStroke(e) {
  ...
  if (drawing && cell) {
    ...
    else setPixel(cell.c, cell.r, paintingValue);
    lastCell = cell;
    needRender = true;
    updateStats();      // 实时统计
  }
...
function endStroke() { drawing = false; lastCell = null; endPan(); }
